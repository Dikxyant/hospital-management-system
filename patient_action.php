...
if($action == 'showdetail') {
    ...
    $sql = "select a.*, p.Name as pname, d.Name as dname from tblappointment a, tblpatient p, tbldoctor d where a.DoctorID=d.AID and a.PatientID=p.AID and p.AID={$_SESSION['go_patientid']}";
